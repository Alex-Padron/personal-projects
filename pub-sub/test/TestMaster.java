...
public class TestMaster {
	...
	public void test() throws IOException {
		...
		msg = new MasterMessage(MessageTypes.REGISTER, Optional.of("path1"), Optional.of("localhost"), Optional.of(1111));
		...
		msg = new MasterMessage(MessageTypes.QUERY, Optional.of("path1"), Optional.empty(), Optional.empty());
		to_server.writeBytes(parser.toJson(msg, MasterMessage.class) + "\n");
		s = from_server.readLine();
		msg = parser.fromJson(s, MasterMessage.class);
		...
		msg = new MasterMessage(MessageTypes.QUERY, Optional.of("path2"), Optional.empty(), Optional.empty());
		to_server.writeBytes(parser.toJson(msg, MasterMessage.class) + "\n");
		s = from_server.readLine();
		msg = parser.fromJson(s, MasterMessage.class);
		assert(msg.type == MessageTypes.NO_PUBLISHER);
		
		msg = new MasterMessage(MessageTypes.REGISTER, Optional.of("path2"), Optional.of("localhost2"), Optional.of(2222));
		to_server.writeBytes(parser.toJson(msg, MasterMessage.class) + "\n");
		s = from_server.readLine();
		msg = parser.fromJson(s, MasterMessage.class);
		assert(msg.type == MessageTypes.ACCEPTED_REGISTER);
		...
		msg = new MasterMessage(MessageTypes.REGISTER, Optional.of("path1"), Optional.of("localhost2"), Optional.of(2222));
		to_server.writeBytes(parser.toJson(msg, MasterMessage.class) + "\n");
		s = from_server.readLine();
		msg = parser.fromJson(s, MasterMessage.class);
		assert(msg.type == MessageTypes.ACCEPTED_REGISTER);
		...
		msg = new MasterMessage(MessageTypes.REMOVE, Optional.of("path1"), Optional.empty(), Optional.empty());
		to_server.writeBytes(parser.toJson(msg, MasterMessage.class) + "\n");
		s = from_server.readLine();
		msg = parser.fromJson(s, MasterMessage.class);
